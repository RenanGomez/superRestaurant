...
- La integración posterior pasó lint, typecheck, 70 pruebas de dominio y 57 del spike, y build global. Los archivos operativos siguen siendo la fuente durable entre sesiones; el árbol greenfield aún no tiene commit porque ADR-006/estrategia Git continúa pendiente de decisión humana.
...
- Elegir estrategia para el prototipo remoto.
