...
- La integración posterior pasó lint, typecheck, 70 pruebas de dominio y 57 del spike, y build global. Los archivos operativos siguen siendo la fuente durable entre sesiones. ADR-006 quedó aceptada: el commit raíz greenfield `ceaffcb` se publicó por HTTPS en `origin/codex/modernizacion-fase0`, sin mezclar ni modificar las ramas legadas.
