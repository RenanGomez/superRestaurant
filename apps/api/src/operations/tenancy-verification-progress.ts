...
export const ORDERS_REALTIME_VERIFICATION_CHECKPOINTS = Object.freeze([
  ...
  "orders_realtime.operational_shift_list_verified",
  "orders_realtime.empty_active_orders_verified",
  "orders_realtime.closed_shift_rejected",
  "orders_realtime.foreign_shift_rejected",
  "orders_realtime.shift_replay_conflict_verified",
  ...
  "orders_realtime.active_snapshots_verified",
  "orders_realtime.multiple_orders_verified",
  "orders_realtime.legacy_null_shift_verified",
  "orders_realtime.active_scope_isolation_verified",
